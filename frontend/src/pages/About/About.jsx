    ...
    return (
        <>
            ...
            <div className="w-full">
                <section className="bg-gradient-to-br from-[#D6A9B4] to-[#B7C1B8] text-white text-center py-10 px-8 relative overflow-hidden h-[45vh] min-h-[350px] flex items-center justify-center">
